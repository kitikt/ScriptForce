...
bạn hãy phân tích ngắn gọn video dưới đây và đánh giá tiềm năng phát triển thành video viral 1,5 tiếng:
...
${normalizeScript(originalScript)}`;
  ...
  },
  {
    ...
    buildPrompt() {
      return `Bước 2:
Bạn phải chỉnh sửa những điểm yếu trong khi vẫn giữ nguyên những điểm mạnh của câu chuyện gốc, trung thành với cốt truyện chính.
...
Vẫn tuân thủ theo cốt 
truyện chính gốc, mở rộng sâu hơn nếu cần
...
không bao giờ được tạo file chỉ trả lời trong chat`;
  ...
  },
  {
    ...
    buildPrompt() {
      return `Bước 3:
Đánh giá dàn ý theo 6 tiêu chí riêng biệt, mỗi tiêu chí thang 10:
...
Bám sát các sự kiện chính của chuyện gốc. Dàn ý viết toàn bộ bằng tiếng Việt chỉ có tên nhân vật, địa danh thì giữ nguyên tiếng anh. (để tôi có thể đọc hiểu), không tự động đổi giới tính của nhân vật chính 
không bao giờ được tạo file chỉ trả lời trong chat`;
    },
  },
  {
...
DỰA VÀO DÀN Ý CHI TIẾT VIẾT PHẦN 1, ĐỘ DÀI 5.000 ĐẾN 5.500 TỪ BẰNG TIẾNG ANH. ĐẢM BẢO ĐẦY ĐỦ TWIST, ĐẢM BẢO ĐỦ THÔNG TIN TRONG DÀN Ý.
...
DỰA VÀO DÀN Ý CHI TIẾT VÀ PHẦN 1 ĐÃ VIẾT, VIẾT PHẦN 2 ĐỘ DÀI 5.000 ĐẾN 5.700 TỪ BẰNG TIẾNG ANH. ĐẢM BẢO ĐẦY ĐỦ TWIST VÀ CLIMAX THEO DÀN Ý.
Chú ý: KHÔNG sử dụng BẤT KỲ DẤU GẠCH NÀO TRONG BÀI. Trả kết quả thường, không phải txt.
QUY TẮC CHỐNG LẶP:
...
không được tạo file chỉ trả lời trong chat`;
  ...
  },
  {
    ...
    buildPrompt() {
      return `bước 7 
DỰA VÀO DÀN Ý CHI TIẾT VÀ PHẦN 1, PHẦN 2 ĐÃ VIẾT, VIẾT PHẦN 3 ĐỘ DÀI 5.000 ĐẾN 5.700 TỪ BẰNG TIẾNG ANH. ĐẢM BẢO ĐẦY ĐỦ TWIST VÀ CLIMAX CUỐI CÙNG THEO DÀN Ý. ĐẢM BẢO KẾT THÚC HOÀN THIỆN, THỎA MÃN NGƯỜI XEM.
Chú ý: KHÔNG sử dụng BẤT KỲ DẤU GẠCH NÀO TRONG BÀI. Trả kết quả thường, không phải txt.
QUY TẮC CHỐNG LẶP:
...
Ghép cả 3 phần đã viết (Phần 1, Phần 2, Phần 3) lại thành kịch bản hoàn chỉnh, TẠO FILE TXT.
Sau khi ghép, đọc lại toàn bộ kịch bản và kiểm tra theo các tiêu chí sau. CHỈ TRẢ LỜI TRONG CHAT, KHÔNG TẠO FILE MỚI Ở BƯỚC NÀY:
...
CẤM BỊA LỖI. Chỉ báo lỗi có thật. Với mỗi lỗi, CHỈ RÕ: vị trí chính xác (trích dẫn câu 
mở đầu của đoạn có lỗi), mô tả lỗi, và cách sửa cụ thể.`;
    },
  },
  {
    stepNumber: 8,
...
Dựa vào danh sách lỗi ở bước trên, hãy sửa TẤT CẢ các lỗi đã liệt kê. Sau đó viết lại kịch bản đã sửa hoàn chỉnh, TẠO FILE TXT MỚI.
